...
class Minified_Files_Check extends Abstract_PHP_CodeSniffer_Check {
	...
	public function get_description(): string {
		return __( 'Detects minified PHP files and tokenization errors.', 'wpverifier' );
	}
	...
	public function get_documentation_url(): string {
		return __( 'https://developer.wordpress.org/plugins/wordpress-org/detailed-plugin-guidelines/#4-code-must-be-mostly-human-readable', 'wpverifier' );
	}
}
